package com.example.Movie_ticket_booking_service.service.paymentServices;
...
public class VNPayService {
    ...
    public String handlePaymentReturn(String responseCode, String vnpTxnRef){
        if("00".equals(responseCode)){
            invoiceService.updateInvoice(vnpTxnRef);
