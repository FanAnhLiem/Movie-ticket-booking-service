...
public class RagDocumentMapper {
    ...
    public Document fromMovie(MovieEntity m){
        String content = """
      Phim: %s
      Thể loại: %s
      Quốc gia: %s
    ...
    public Document fromCinema(CinemaEntity c) {
        String content = """
      Rạp: %s
      Loại rạp: %s
      Địa chỉ: %s
    ...
    public Document fromScreenRoom(ScreenRoomEntity s) {
        String content = """
      Phòng chiếu: %s
      Thuộc rạp: %s
      Loại phòng: %s
    ...
    public Document fromScreenRoomType(ScreenRoomTypeEntity srt) {
        String content = """
      Loại phòng chiếu: %s
      Trạng thái: %s
      """.formatted(
